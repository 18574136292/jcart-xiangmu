const ProductUpdate ={
    ...
    <div id="app">
        ...
        <el-page-header @back="handleBackClick" content="商品编辑"></el-page-header><br>
        ...
        上传后其他图片：
        <br>
        <div v-for="item in otherPicUrls" class="demo-image_preview">
    ...
    methods:{
        ...
        handleOnMainChange(value){
            this.selectedMainPic = value.raw;
        },
