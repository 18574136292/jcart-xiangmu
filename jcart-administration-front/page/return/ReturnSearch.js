const ReturnSearch ={
        ...
        <el-table :data="pageInfo.list" style="width: 100%">
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" @click="handleSearchReturnHistoryClick(scope.$index, scope.row)">查看退货历史</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods:{
        handleSearchReturnHistoryClick(index,row){
            console.log('search return history',index,row);
            this.$router.push('/returnHistory/getListByReturnId/' + row.returnId);
        },
        handleShow(index,row){
            console.log('return show');
            this.$router.push('/return/getById/' + row.returnId);
        },
        handleSearchClick(){
